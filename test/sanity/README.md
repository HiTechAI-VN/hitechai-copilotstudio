# HiTechAi Studio Code Release Sanity Check Tests

## Overview

Automated end-to-end release sanity tests for published HiTechAi Studio Code builds.
...
Many tests will use the underlying platform to install and verify basic HiTechAi Studio Code functionality.
...
- Architecture-specific HiTechAi Studio Code dependencies
...
The following public documentation pages provide details on end-user HiTechAi Studio Code setup scenarios.

- [Download HiTechAi Studio Code](https://code.visualstudio.com/Download)
...
- [HiTechAi Studio Code Server](https://code.visualstudio.com/docs/remote/vscode-server)
