...
export function applyWindowTools(server: McpServer, appService: ApplicationService): RegisteredTool[] {
	...
	tools.push(server.tool(
		...
		'List all open HiTechAi Studio Code windows with their index and URL',
		async () => {
	...
	tools.push(server.tool(
		...
		'Switch to a different HiTechAi Studio Code window by index or URL pattern (e.g., "agent.html")',
		{
