...
logger.log(`HiTechAi Studio Code product quality: ${quality}.`);
...
async function ensureStableCode(): Promise<void> {
	...
	if (!stableCodePath) {
		...
		logger.log(`Found HiTechAi Studio Code v${version}, downloading previous HiTechAi Studio Code version ${stableVersion}...`);
		...
		if (process.platform === 'darwin') {
			// HiTechAi Studio Code.app/Contents/MacOS/Code
