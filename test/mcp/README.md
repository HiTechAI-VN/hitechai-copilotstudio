...
This directory contains a Model Context Protocol (MCP) server that provides HiTechAi Studio Code automation capabilities for Code - OSS development and testing. The MCP server exposes Code - OSS's testing infrastructure through a standardized interface, allowing AI assistants and other tools to interact with HiTechAi Studio Code programmatically.

## What is MCP?

The [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) is an open standard that enables AI assistants to securely connect to external data sources and tools. This MCP server specifically provides HiTechAi Studio Code automation capabilities, making it possible for AI assistants to:

- Start and stop HiTechAi Studio Code instances
...
The MCP server exposes a comprehensive set of HiTechAi Studio Code automation tools through the MCP protocol:

### Application Management
- Start, stop, and restart HiTechAi Studio Code instances
...
│   ├── application.ts       # HiTechAi Studio Code application lifecycle management
...
- **application.ts** - Manages HiTechAi Studio Code application lifecycle (start, stop, restart)
- **automationTools/** - Modular tool implementations organized by HiTechAi Studio Code feature area
