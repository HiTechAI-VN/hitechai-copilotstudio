...
3.  Avoid making changes to core HiTechAi Studio Code files (`src/vs/workbench/`, `src/vs/platform/`, etc.) unless absolutely necessary for the agents window functionality.
