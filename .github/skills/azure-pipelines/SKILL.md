...
description: Use when validating Azure DevOps pipeline changes for the HiTechAi Studio Code build. Covers queueing builds, checking build status, viewing logs, and iterating on pipeline YAML changes without waiting for full CI runs.
---
...
## HiTechAi Studio Code Main Build

The main HiTechAi Studio Code build pipeline:
- **Organization**: `monacotools`
- **Project**: `Monaco`
- **Definition ID**: `111`
- **URL**: https://dev.azure.com/monacotools/Monaco/_build?definitionId=111

## HiTechAi Studio Code Insider Scheduled Builds
