...
If the user needs the agent to launch HiTechAi Studio Code, drive a scenario, and capture snapshots first, use the HiTechAi Studio Code performance workflow skill before returning here for low-level snapshot analysis.
...
### Common HiTechAi Studio Code Retention Patterns
