...
### HiTechAi Studio Code Log Artifacts Structure
...
Common patterns in HiTechAi Studio Code CI:
...
2. Verify compilation: check the `HiTechAi Studio Code - Build` task or run `npm run compile-check-ts-native`
