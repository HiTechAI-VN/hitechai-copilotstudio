...
3. `agent_monitoring.md` ("HiTechAi Studio Code Settings", "Environment Variables", "Activation", "Commands" tables) **and** `agent_monitoring_arch.md` ("Activation Channels", "Agent-Specific Env Var Translation" tables).
...
- The Agent Debug Log panel in HiTechAi Studio Code still shows the full span tree for foreground, Copilot CLI, and Claude sessions.
