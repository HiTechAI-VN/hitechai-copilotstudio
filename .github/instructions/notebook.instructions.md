---
description: Architecture documentation for HiTechAi Studio Code notebook and interactive window components. Use when working in `src/vs/workbench/contrib/notebook/`
---

# Notebook Architecture

This document describes the internal architecture of HiTechAi Studio Code's notebook implementation.
