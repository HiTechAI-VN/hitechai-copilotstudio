---
description: Use when asked to consume workbench tree widgets in HiTechAi Studio Code.
---
...
The Workbench Tree Widgets provide high-level, workbench-integrated tree components that extend the base tree implementations with HiTechAi Studio Code-specific functionality like context menus, keyboard navigation, theming, accessibility, and dependency injection integration. These widgets serve as the primary tree components used throughout the HiTechAi Studio Code workbench for file explorers, debug views, search results, and other hierarchical data presentations.

## Scope

### Included Functionality
- **Context Integration**: Automatic context key management, focus handling, and HiTechAi Studio Code theme integration
...
- **Dependency Injection**: Full integration with HiTechAi Studio Code's service container for automatic service injection
