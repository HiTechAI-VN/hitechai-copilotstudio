...
impl CodeVersionManager {
	...
	/// Tries to find the binary entrypoint for HiTechAi Studio Code installed in the path.
...
fn detect_installed_program(log: &log::Logger) -> io::Result<Vec<PathBuf>> {
	...
	//
	//     HiTechAi Studio Code - Exploration 2:
	//
	//        Version: 1.73.0-exploration
	//        Obtained from: Identified Developer
	//        Last Modified: 9/23/22, 10:16 AM
	//        Kind: Intel
	//        Signed by: Developer ID Application: Pho Tue SoftWare Solutions JSC (UBF8T346G9), Developer ID Certification Authority, Apple Root CA
	//        Location: /Users/connor/Downloads/HiTechAi Studio Code - Exploration 2.app
	//
...
mod tests {
	...
	fn test_detect_installed_program() {
		// developers can run this test and debug output manually; HiTechAi Studio Code will not
