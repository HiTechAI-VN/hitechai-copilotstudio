...
/// Server params that can be used to start a HiTechAi Studio Code server.
...
/// A type that can be used to scan stdout from the HiTechAi Studio Code server. Returns
