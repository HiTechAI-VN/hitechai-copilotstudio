...
// When the provided connection token doesn't match the one used to set up the original HiTechAi Studio Code Server
...
// When the HiTechAi Studio Code server has an unrecognized extension (rather than zip or gz)
#[derive(Debug)]
...
/// Internal errors in the HiTechAi Studio Code CLI.
