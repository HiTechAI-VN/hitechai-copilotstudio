...
/**
 * A data transfer item that has been created by HiTechAi Studio Code instead of by a extension.
 *
...
export enum ExtensionMode {
	 ...
	 * or VSIX) in HiTechAi Studio Code.
	 */
	Production = 1,

	/**
	 * The extension is running from an `--extensionDevelopmentPath` provided
	 * when launching HiTechAi Studio Code.
	 */
	Development = 2,
