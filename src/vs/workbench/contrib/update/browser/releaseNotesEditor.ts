 ...
 * - `IN_PRODUCT` - Content shown in HiTechAi Studio Code (both Stable and Insiders)
 * - `WEB` - Content shown on the website only
 * - `STABLE` - Content shown in HiTechAi Studio Code Stable only
 * - `INSIDERS` - Content shown in HiTechAi Studio Code Insiders only
 *
