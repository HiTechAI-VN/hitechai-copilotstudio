...
suite('Workbench - TerminalInstance', () => {
	...
	suite('TerminalInstance', () => {
		...
		test('custom key event handler should handle commands in DEFAULT_COMMANDS_TO_SKIP_SHELL in HiTechAi Studio Code and not xterm when sendKeybindingsToShell is disabled', async () => {
