 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in HiTechAi Studio Code UI).
 */
 ...
 * to represent terminals that appear in other parts of the HiTechAi Studio Code UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their HiTechAi Studio Code OSC `SetMarker`
...
export interface IDetachedXtermTerminal extends IXtermTerminal {
	...
	/**
	 * Updates the xterm log level to match the given HiTechAi Studio Code log level.
	 */
	updateLogLevel(): void;
