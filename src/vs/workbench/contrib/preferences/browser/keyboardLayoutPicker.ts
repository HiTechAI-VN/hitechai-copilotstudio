...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in HiTechAi Studio Code in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open HiTechAi Studio Code and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
