...
/**
 * Allows webviews to monitor when an element in the HiTechAi Studio Code editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. HiTechAi Studio Code needs to see this
