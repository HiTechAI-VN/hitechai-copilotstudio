		...
		const sendRequestInternal = async () => {
			...
			try {
				...
				if (agentPart || (defaultAgent && !commandPart)) {
					...
					// MCP autostart: only run for native HiTechAi Studio Code sessions (sidebar, new editors) but not for extension contributed sessions that have inputType set.
