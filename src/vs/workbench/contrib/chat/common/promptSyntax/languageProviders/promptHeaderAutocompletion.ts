...
export class PromptHeaderAutocompletion implements CompletionItemProvider {
	...
	private provideHookEventCompletions(
		...
		// Start the range after leading whitespace so HiTechAi Studio Code's completion
	...
	private provideHookCommandFieldCompletions(
		...
		// actual field name; otherwise HiTechAi Studio Code's completion filter would see the
