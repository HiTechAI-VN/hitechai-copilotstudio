 ...
 *
 * The default (core) registration exposes a single "HiTechAi Studio Code" harness
...
export interface ICustomizationHarnessService {
	 ...
	 * HiTechAi Studio Code harness falls back to the core prompts service.
	 */
	 ...
	 * Provider-backed harnesses resolve their own items directly; the default HiTechAi Studio Code harness falls back to the core prompts service.
	 */
...
/**
 * Creates a "HiTechAi Studio Code" harness descriptor that shows all storage sources
