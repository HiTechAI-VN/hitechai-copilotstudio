 ...
 * instructions, and agents available as the local HiTechAi Studio Code client.
 */
 ...
 * any per-provider plumbing. In the regular HiTechAi Studio Code workbench window the
