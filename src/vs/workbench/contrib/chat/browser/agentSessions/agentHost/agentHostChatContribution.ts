...
export class AgentHostContribution extends Disposable implements IWorkbenchContribution {
	...
	private _registerAgent(agent: AgentInfo): void {
		...
		// only agent-host sessions exist there. In HiTechAi Studio Code, the same picker
		...
		// sessions (matches behavior of remote agent host sessions). In HiTechAi Studio Code,
	 ...
	 * Resolves tokens via the standard HiTechAi Studio Code authentication service.
	 */
