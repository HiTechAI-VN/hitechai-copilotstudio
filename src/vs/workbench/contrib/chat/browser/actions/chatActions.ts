...
const defaultChat = {
	...
	enterpriseProviderId: product.defaultChatAgent?.provider?.enterprise?.id ?? '',
...
export function registerChatActions() {
	...
	const nonEnterpriseCopilotUsers = defaultChat.completionsAdvancedSetting && defaultChat.enterpriseProviderId
		? ContextKeyExpr.and(ChatContextKeys.enabled, ContextKeyExpr.notEquals(`config.${defaultChat.completionsAdvancedSetting}.authProvider`, defaultChat.enterpriseProviderId))
