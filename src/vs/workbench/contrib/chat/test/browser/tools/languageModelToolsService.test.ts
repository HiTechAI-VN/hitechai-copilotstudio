...
suite('LanguageModelToolsService', () => {
	...
	test('toToolAndToolSetEnablementMap map Github to VSCode tools', () => {
...

		{
			...
			assert.deepStrictEqual(fullReferenceNames, [SpecedToolAliases.agent, SpecedToolAliases.execute].sort(), 'toFullReferenceNames should return the HiTechAi Studio Code tool names');
		...
		}
		{
			...
			const fullReferenceNames = service.toFullReferenceNames(result).sort();
			assert.deepStrictEqual(fullReferenceNames, ['github/*', 'playwright/*'], 'toFullReferenceNames should return the HiTechAi Studio Code tool names');
...

		{
			...
			assert.strictEqual(result.get(githubMcpTool1), true, 'githubMcpTool1 should be enabled');
			const fullReferenceNames = service.toFullReferenceNames(result).sort();
			assert.deepStrictEqual(fullReferenceNames, ['github/create_branch'], 'toFullReferenceNames should return the HiTechAi Studio Code tool names');
