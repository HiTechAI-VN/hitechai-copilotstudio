...
/**
 * A representation of an MCP resource. The `uri` is namespaced to HiTechAi Studio Code and
 * can be used in filesystem APIs.
 */
export interface IMcpResource {
	/** Identifier for the file in HiTechAi Studio Code and operable with filesystem API */
	readonly uri: URI;
