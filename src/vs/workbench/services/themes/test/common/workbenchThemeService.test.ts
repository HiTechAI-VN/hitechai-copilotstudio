...
suite('WorkbenchThemeService', () => {
	...
	suite('migrateThemeSettingsId', () => {
		...
		test('migrates Experimental theme IDs to HiTechAi Studio Code themes', () => {
			assert.deepStrictEqual(
				['Experimental Dark', 'Experimental Light', 'HiTechAi Studio Code Dark', 'HiTechAi Studio Code Light'].map(migrateThemeSettingsId),
