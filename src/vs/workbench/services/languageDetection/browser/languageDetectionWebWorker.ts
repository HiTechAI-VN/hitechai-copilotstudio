...
export class LanguageDetectionWorker implements ILanguageDetectionWorker {
	...
	// * HiTechAi Studio Code's language usage
	...
	private adjustLanguageConfidence(modelResult: ModelResult): ModelResult {
		switch (modelResult.languageId) {
			...
			// these are commonly used languages in HiTechAi Studio Code and supported
			// by the model.
			case 'js':
			case 'html':
			case 'json':
			...
			// languages that are provided by default in HiTechAi Studio Code
			case 'bat':
			case 'ini':
			case 'makefile':
			case 'sql':
			// languages that aren't provided by default in HiTechAi Studio Code
			case 'csv':
			case 'toml':
