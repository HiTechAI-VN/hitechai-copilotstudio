...
export interface IShellLaunchConfig {
	 ...
	 * from the HiTechAi Studio Code process.
	 */
	...
	/**
	 * Whether the terminal process environment will inherit HiTechAi Studio Code's "shell environment" that may
	 ...
	 * a terminal used to drive some HiTechAi Studio Code feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to HiTechAi Studio Code and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** HiTechAi Studio Code shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
