...
// (synced from the agent-host-protocol repo). This file adds HiTechAi Studio Code-specific
...
// ---- HiTechAi Studio Code-specific derived types -----------------------------------------
...
/**
 * HiTechAi Studio Code-side alias for the protocol's open `_meta` property bag on
 ...
 * {@link ISessionGitState}. This is a HiTechAi Studio Code-specific convention layered
