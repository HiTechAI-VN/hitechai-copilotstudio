...
// Re-exports the protocol reducers and adds HiTechAi Studio Code-specific helpers.
...
/**
 * Extracts the HiTechAi Studio Code-specific `toolKind` hint from a tool call's `_meta`
