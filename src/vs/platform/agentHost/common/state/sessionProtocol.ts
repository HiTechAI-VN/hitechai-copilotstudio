...
// This file adds HiTechAi Studio Code-specific additions (ISetAuthTokenParams, ProtocolError)
...
// ---- HiTechAi Studio Code-specific types ------------------------------------------------
...
/**
 * HiTechAi Studio Code-specific extension: set the auth token on the server.
