...
export interface IRemoteAgentHostSSHConnection {
	 ...
	 * HiTechAi Studio Code Remote SSH authority.
	 */
	 ...
	 * client connects to, and is used to construct the HiTechAi Studio Code Remote
...
export interface IRemoteAgentHostTunnelConnection {
	 ...
	 * Used as the tunnel name in the HiTechAi Studio Code Remote Tunnels authority
