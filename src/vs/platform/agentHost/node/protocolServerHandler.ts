...
export class ProtocolServerHandler extends Disposable {
	...
	private _handleRequest(client: IConnectedClient, method: string, params: unknown, id: number): void {
		...
		// HiTechAi Studio Code extension methods (not in the typed protocol maps yet)
	...
	/**
	 * Handle HiTechAi Studio Code extension methods that are not yet part of the typed
