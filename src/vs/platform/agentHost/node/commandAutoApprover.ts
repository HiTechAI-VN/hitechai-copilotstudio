 ...
 * The default rules mirror the HiTechAi Studio Code `chat.tools.terminal.autoApprove`
 * setting defaults.
 *
...
// ---- Default rules ----------------------------------------------------------
//
// These mirror the HiTechAi Studio Code `chat.tools.terminal.autoApprove` setting defaults.
