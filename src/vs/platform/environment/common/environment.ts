...
export interface IEnvironmentService {
	 ...
	 * the host HiTechAi Studio Code application (i.e. the default profile's settings/User
	 ...
	 * HiTechAi Studio Code application (e.g. `~/.vscode-insiders`). This identifies the
	 ...
	 * the host HiTechAi Studio Code application. `undefined` when not running as embedded.
	 */
