...
export type UpdateErrorClassification = {
	...
	comment: 'This is used to know how often HiTechAi Studio Code updates have failed.';
};
...
export abstract class AbstractUpdateService implements IUpdateService {
	...
	private async trackVersionChange(): Promise<void> {
		...
		type VersionChangeClassification = {
			owner: 'dmitriv';
			comment: 'Fired when HiTechAi Studio Code detects a version change on startup.';
			fromVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The previous version of HiTechAi Studio Code.' };
			...
			toVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The current version of HiTechAi Studio Code.' };
