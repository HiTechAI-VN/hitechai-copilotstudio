...
export abstract class AbstractExtensionGalleryService implements IExtensionGalleryService {
	...
	async getExtensionsControlManifest(): Promise<IExtensionsControlManifest> {
		...
		const defaultChatExtensionId = defaultChatAgent.extensionId.toLowerCase();
		const defaultChatExtensionReplacementId = defaultChatAgent.chatExtensionId.toLowerCase();
		if (defaultChatExtensionId && defaultChatExtensionReplacementId && defaultChatExtensionId !== defaultChatExtensionReplacementId) {
			deprecated[defaultChatExtensionId] = {
				disallowInstall: true,
				extension: {
					id: defaultChatAgent.chatExtensionId,
					displayName: defaultChatAgent.chatExtensionOutputId,
