...
export enum Filters {
	...
	/**
	 * The language in use by HiTechAi Studio Code
	 */
	...
	/**
	 * The platform (OS) on which HiTechAi Studio Code is running.
	 */
	Platform = 'X-VSCode-Platform',

	/**
	 * The release/build date of HiTechAi Studio Code (UTC) in the format yyyymmddHH.
	 */
