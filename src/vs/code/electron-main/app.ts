...
/**
 * The main HiTechAi Studio Code application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting HiTechAi Studio Code');
		...
		// "com.microsoft.", which breaks native tabs for HiTechAi Studio Code when using this
