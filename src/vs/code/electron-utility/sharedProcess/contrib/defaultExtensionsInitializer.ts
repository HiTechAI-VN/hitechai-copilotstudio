...
export class DefaultExtensionsInitializer extends Disposable {
	...
	private getDefaultExtensionVSIXsLocation(): URI {
		if (this.productService.win32VersionedUpdate) {
			...
			// extensionsPath = C:\Users\<name>\AppData\Local\Programs\Microsoft HiTechAi Studio Code Insiders\<version>\bootstrap\extensions
			...
			// extensionsPath = C:\Users\<name>\AppData\Local\Programs\Microsoft HiTechAi Studio Code Insiders\bootstrap\extensions
