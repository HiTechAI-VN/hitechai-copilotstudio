...
export class WorkspacePicker extends Disposable {
	...
	/** Cached HiTechAi Studio Code recent folder URIs, resolved lazily. */
	...
	constructor(
		...
		// Load HiTechAi Studio Code recent folders eagerly and refresh on changes
	 ...
	 * without source grouping. Own recents come first, followed by HiTechAi Studio Code
	 * recent folders.
	 */
	protected _buildItems(): IActionListItem<IWorkspacePickerItem>[] {
		...
		// Merge HiTechAi Studio Code recent folders (resolved through providers, deduplicated)
	...
	// -- HiTechAi Studio Code recent folders -----------------------------------------------
	...
	/**
	 * Returns HiTechAi Studio Code recent folders resolved through registered session
