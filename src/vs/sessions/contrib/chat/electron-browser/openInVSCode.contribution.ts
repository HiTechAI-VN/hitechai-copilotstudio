...
/**
 * Desktop version of the "Open in HiTechAi Studio Code" action.
 *
 * In built builds with a sibling app configured, launches the host HiTechAi Studio Code app
...
registerAction2(class OpenSessionWorktreeInVSCodeAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('openInVSCode', 'Open in HiTechAi Studio Code'),
