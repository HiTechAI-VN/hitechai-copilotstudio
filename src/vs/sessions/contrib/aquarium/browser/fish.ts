...
/**
 * HiTechAi Studio Code logo "fish" used by the Agents window aquarium. Each fish is a small
...
/** The three HiTechAi Studio Code release channel colors used as fish "species". */
 ...
 * a single `<symbol>` containing the HiTechAi Studio Code logo path. All fish reference
 ...
 *   - HiTechAi Studio Code logo body, sliced into N vertical strips that each oscillate in
...
function buildFishSvg(targetDocument: Document): SVGSVGElement {
	...
	// viewBox 0..96 matches the original HiTechAi Studio Code icon.
