...
6. Confirm the path is NOT the HiTechAi Studio Code profile folder (e.g., NOT `~/.vscode-oss-sessions-dev/User/...`)
...
- User file is created under `~/.copilot/instructions/` (not the HiTechAi Studio Code profile folder)
...
- The HiTechAi Studio Code profile folder should never be used for user creation in sessions
