...
suite('Labels', () => {
	...
	test('template', () => {
		...
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: '', rootName: '', appName: 'HiTechAi Studio Code', separator: { label: ' - ' } }), 'HiTechAi Studio Code');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: 'Untitled-1', rootName: '', appName: 'HiTechAi Studio Code', separator: { label: ' - ' } }), 'Untitled-1 - HiTechAi Studio Code');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: '', rootName: 'monaco', appName: 'HiTechAi Studio Code', separator: { label: ' - ' } }), 'monaco - HiTechAi Studio Code');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: 'somefile.txt', rootName: 'monaco', appName: 'HiTechAi Studio Code', separator: { label: ' - ' } }), 'somefile.txt - monaco - HiTechAi Studio Code');
		assert.strictEqual(labels.template(t, { dirty: '* ', activeEditorShort: 'somefile.txt', rootName: 'monaco', appName: 'HiTechAi Studio Code', separator: { label: ' - ' } }), '* somefile.txt - monaco - HiTechAi Studio Code');

		// real world example (other)
		t = '${dirty}${activeEditorShort}${separator}${rootNameShort}${separator}${appName}';
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: '', rootName: 'monaco (Workspace)', rootNameShort: 'monaco', appName: 'HiTechAi Studio Code', separator: { label: ' - ' } }), 'monaco - HiTechAi Studio Code');
	});
