...
export class ToggleTabFocusModeAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: nls.localize2({ key: 'toggle.tabMovesFocus', comment: ['Turn on/off use of tab key for moving focus around HiTechAi Studio Code'] }, 'Toggle Tab Key Moves Focus'),
