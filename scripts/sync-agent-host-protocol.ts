...
//
// URI stays as `string` (the protocol's canonical representation). HiTechAi Studio Code code
...
function main() {
	if (!fs.existsSync(TYPES_DIR)) {
		...
		console.error('Clone agent-host-protocol as a sibling of the HiTechAi Studio Code repo:');
