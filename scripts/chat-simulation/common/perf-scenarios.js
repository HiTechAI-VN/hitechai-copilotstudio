...
const CONTENT_SCENARIOS = {
	...
	'giant-codeblock': {
		...
		chunks: (() => {
			...
			b.emit('```\n\nThis defines 40 service classes following the standard HiTechAi Studio Code pattern.\n');
			return b.build();
		})(),
	},
			...
			return {
				...
				turns: [
					...
					},
					{
						kind: 'content',
						chunks: new ScenarioBuilder()
							.wait(20, '## Analysis of HiTechAi Studio Code Base Utilities\n\n')
							.stream([
					...
					// Round 3: final content
					{
						...
						chunks: new ScenarioBuilder()
							...
							.stream([
								...
								'Both files follow the standard HiTechAi Studio Code pattern of using `Disposable` as a base class ',
			...
			turns: [
				{
					...
					thinkingChunks: new ScenarioBuilder()
						.stream([
							...
							'The user is asking about the lifecycle pattern in HiTechAi Studio Code. ',
