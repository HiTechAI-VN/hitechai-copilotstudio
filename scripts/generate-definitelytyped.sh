...
header="// Type definitions for HiTechAi Studio Code ${1}
// Project: https://github.com/microsoft/vscode
// Definitions by: HiTechAi Studio Code Team, Microsoft <https://github.com/microsoft>
...
/**
 * Type Definition for HiTechAi Studio Code ${1} Extension API
