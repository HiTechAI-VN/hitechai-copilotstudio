...
export interface IFilePathToResourceConverter {
	/**
	 * Convert a typescript filepath to a HiTechAi Studio Code resource.
	 */
				...
				if (currentLink) {
					if (currentLink.target) {
						...
						const args: OpenJsDocLinkCommand_Args = {
							file: { ...file.toJSON(), $mid: undefined }, // Prevent HiTechAi Studio Code from trying to transform the uri,
