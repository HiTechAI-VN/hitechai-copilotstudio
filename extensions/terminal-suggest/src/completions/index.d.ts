...
declare namespace Fig {
	...
	interface Generator {
		...
		script?:
		| string[]
		| Function<string[], string[] | undefined> // <-- HiTechAi Studio Code edit to make results correct
		| ExecuteCommandInput
		 ...
		 *
		 */
		postProcess?: (out: string, tokens: string[]) => (Suggestion | null)[] | undefined; // <-- HiTechAi Studio Code edit to make results correct
		/**
		...
		) => Promise<(Suggestion | null)[] | undefined>; // <-- HiTechAi Studio Code edit to make results correct
		/**
		 *
