...
For more information about output formatting flags, see 'gh help formatting'`,
		...
		},
		{
			...
			subcommands: [
				{
					name: "code",
					description: "Open a codespace in HiTechAi Studio Code",
					options: [
						codespaceOption,
						{
							name: "--insiders",
							description: "Use the insiders version of HiTechAi Studio Code",
						},
						{
							name: ["-w", "--web"],
							description: "Use the web version of HiTechAi Studio Code",
						},
					],
				},
				{
