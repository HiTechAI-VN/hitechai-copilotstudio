 ...
 * like GIT_ASKPASS point to scripts inside the HiTechAi Studio Code installation directory, which
...
/**
 * Checks if the current HiTechAi Studio Code installation is a Windows user or system setup.
 ...
 * This prevents accumulation of old versions when HiTechAi Studio Code updates.
 */
